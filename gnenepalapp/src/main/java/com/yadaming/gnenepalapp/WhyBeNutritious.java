...
public class WhyBeNutritious extends Activity
{
    public void nextMethodWhyBeNutritious(View view)
    {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_why_be_nutritious);

        SoundModule SoundModule = new SoundModule(this);
        SoundModule.play(R.raw.slide_27);
    }
